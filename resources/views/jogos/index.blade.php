                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="GET" action="{{ route('jogos.index') }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                            ...
                            <div>
                                <label for="campeonato_id"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Campeonato</label>
                                <select id="campeonato_id" name="campeonato_id"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                            ...
                            <div class="flex space-x-2">
                                ...
                                <div class="w-1/2">
                                    <label for="data_fim"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Até</label>
                        ...
                        <div class="mt-4 flex justify-end">
                            ...
                            <button type="submit"
                                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Filtrar</button>
                        </div>
                    </form>
                    ...
                    @if (session('success'))
                        <div id="success-message"
                            class="bg-green-500 text-white font-bold py-2 px-4 rounded mb-4 flash-message">
                            {{ session('success') }}
                        </div>
                    @endif
                                ...
                                @forelse ($jogos as $jogo)
                                    <tr
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            ...
                                            @if($statusApontamento == 'verde')
                                                <div class="flex justify-center" title="Ainda vai acontecer">
                                            ...
                                            @elseif($statusApontamento == 'amarelo')
                                                <div class="flex justify-center" title="Período do Jogo">
                                            ...
                                            @elseif($statusApontamento == 'vermelho')
                                                <div class="flex justify-center animate-pulse" title="Necessário Apontamento">
                                            ...
                                            @elseif($statusApontamento == 'concluido')
                                                <div class="flex justify-center" title="Concluído">
                                        ...
                                        <td class="py-3 px-6 text-center">
                                            ...
                                            <div class="mb-2">
                                                @if($resStatus == 'aprovado')
                                                    <span
                                                        class="bg-green-100 text-green-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-green-900 dark:text-green-300">Res.
                                                        Aprovado</span>
                                                @elseif($resStatus == 'pendente')
                                                    <span
                                                        class="bg-yellow-100 text-yellow-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-yellow-900 dark:text-yellow-300">Res.
                                                        Pendente</span>
                                                @endif
                                            </div>
                                            ...
                                            <div class="flex item-center justify-center">
                                                ...
                                                @if(auth()->user()->hasRole('Administrador') || (isset($jogo->jgo_apontador) && auth()->user()->id == $jogo->jgo_apontador))
                                                    <a href="{{ route('resultados.create', $jogo->ID) }}"
                                                        class="mr-2 transform hover:text-blue-500 hover:scale-110"
                                                ...
                                                @if($resStatus == 'pendente' && auth()->user()->hasRole('Administrador'))
                                                    <form action="{{ route('resultados.approve', $jogo->local_id ?? 0) }}"
                                                        method="POST"
                                                        class="mr-2 transform hover:text-green-500 hover:scale-110"
                                                        onsubmit="return confirm('Aprovar este resultado?');">
                                                        @csrf
                                                        @method('PATCH')
