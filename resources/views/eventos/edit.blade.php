                            ...
                            <div class="mb-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 bg-gray-50 dark:bg-gray-700 p-4 rounded">
                                    <div>
                                        ...
                                        <input type="date" name="cpo_dt_fim_classificacao" id="cpo_dt_fim_classificacao" class="w-full border border-gray-300 p-2 rounded" value="{{ old('cpo_dt_fim_classificacao', $campeonato->cpo_dt_fim_classificacao) }}">
                                    </div>
                                    <div>
                                        <label for="cpo_dt_fim_finais" class="block text-sm text-gray-700 dark:text-gray-300">Data Limite (Semi Final e Final):</label>
                                        <input type="date" name="cpo_dt_fim_finais" id="cpo_dt_fim_finais" class="w-full border border-gray-300 p-2 rounded" value="{{ old('cpo_dt_fim_finais', $campeonato->cpo_dt_fim_finais) }}">
                                    </div>
                                </div>
                            </div>
