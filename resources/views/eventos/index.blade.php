                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-6 py-4 flex flex-col space-y-2 justify-center items-center">
                                            ...
                                            <div class="flex space-x-2 w-full justify-center items-center">
                                                ...
                                                <a href="{{ route('agendamentos.admin.index', ['campeonato' => $campeonato->cpo_id]) }}" title="Gerar e Aprovar Agendamentos" class="w-4 mr-2 transform text-green-600 hover:text-green-800 hover:scale-110">
