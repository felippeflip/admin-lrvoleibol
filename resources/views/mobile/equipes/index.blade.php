                    ...
                    <div class="px-4 pb-4 pt-1 bg-gray-50 dark:bg-gray-900 gap-3 grid grid-cols-2">
                        ...
                        @if($equipe->campeonatos->count() > 0)
                            <div class="col-span-1">
                                <button type="button" class="w-full flex items-center justify-center gap-2 bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 py-3 rounded-2xl text-[11px] font-black uppercase text-gray-400 dark:text-gray-500 shadow-sm transition cursor-not-allowed" onclick="alert('Esta equipe está inscrita em um ou mais campeonatos.\n\nÉ necessário remover a equipe dos campeonatos antes de poder excluí-la.')">
