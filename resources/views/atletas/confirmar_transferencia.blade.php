<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Confirmar Transferência de Atleta') }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-8 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-6 mb-8 border border-gray-200 dark:border-gray-600">
                        <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-4 border-b border-gray-200 dark:border-gray-600 pb-2">Detalhes do Atleta Encontrado</h3>
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            ...
                            <div class="flex-grow grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-gray-500 dark:text-gray-400">CPF Informado:</p>
                                    <p class="text-lg text-gray-800 dark:text-gray-200 font-medium">{{ $atleta->atl_cpf_formatted }}</p>
                                </div>
                                <div>
                                    <p class="text-sm font-semibold text-gray-500 dark:text-gray-400">Data de Nascimento:</p>
                                    <p class="text-lg text-gray-800 dark:text-gray-200 font-medium">{{ $atleta->atl_dt_nasc_formatted ?? 'Não informada' }}</p>
                                </div>
                                <div>
                    ...
                    <div class="bg-indigo-50 dark:bg-indigo-900/40 rounded-lg p-6 border border-indigo-100 dark:border-indigo-800 flex items-center justify-between flex-col sm:flex-row gap-4">
                        <div class="text-center sm:text-left">
                            <h4 class="text-lg font-bold text-indigo-800 dark:text-indigo-300">Deseja trazer este atleta para sua equipe?</h4>
                            <p class="text-indigo-600 dark:text-indigo-400 mt-1">
                                O atleta será transferido para a equipe <span class="font-bold text-indigo-900 dark:text-indigo-200 px-1">{{ $novoTime->tim_nome }}</span>.
                            </p>
                            <p class="text-sm text-indigo-500 dark:text-indigo-400 mt-2">Esta ação ficará registrada no histórico de transferências do atleta.</p>
                        </div>
