                                            ...
                                            <td class="py-3 px-6 text-center">
                                                <div class="flex item-center justify-center">
                                                    ...
                                                    @if($atleta->atl_documento)
                                                        <a href="{{ $atleta->atl_documento_url }}" target="_blank"
                                                            class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110 flex items-center" title="Visualizar Documento">
                                                    ...
                                                    @if(auth()->user()->hasRole('Administrador'))
                                                        <a href="{{ route('atletas.transferencia-direta', $atleta->atl_id) }}"
                                                            class="w-4 mr-2 transform hover:text-blue-500 hover:scale-110 flex items-center" title="Transferir Atleta">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
