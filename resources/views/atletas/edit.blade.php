            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="container mx-auto p-4">
                        ...
                        @endif
                        <form action="{{ route('atletas.update', $atleta->atl_id) }}" method="POST"
                            enctype="multipart/form-data" id="atletaFormEdit">
                            @csrf
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="atl_tim_id" id="atl_tim_id"
                                        ...
                                        @foreach($times as $time)
                                            <option value="{{ $time->tim_id }}" {{ old('atl_tim_id', $atleta->atl_tim_id) == $time->tim_id ? 'selected' : '' }}>{{ $time->tim_nome }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                                <div class="md:col-span-1 flex flex-col items-center justify-center">
                                    ...
                                    <div
                                        ...
                                        <img id="fotoPreview" src="{{ $atleta->atl_foto_url }}"
                                    ...
                                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-300" id="foto_help">Tamanho
                                        ideal: 3x4 (proporção). Deixe em branco para manter a foto atual.</p>
                                </div>
                                <div class="md:col-span-3">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                        <div class="md:col-span-2 flex items-center mt-2 mb-2">
                                            <input id="atl_estrangeiro" name="atl_estrangeiro" type="checkbox" value="1" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500" {{ old('atl_estrangeiro', $atleta->atl_estrangeiro) ? 'checked' : '' }}>
                                        ...
                                        <div id="container_documento">
                                            <div id="div_cpf">
                                                ...
                                                <input type="text" name="atl_cpf" id="atl_cpf"
                                                    class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                                    value="{{ old('atl_cpf', $atleta->atl_cpf_formatted) }}" maxlength="14">
                                            </div>
                                            <div id="div_passaporte" style="display: none;">
                                                ...
                                                <input type="text" name="atl_passaporte" id="atl_passaporte"
                                                    class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                                    value="{{ old('atl_passaporte', $atleta->atl_passaporte) }}" maxlength="50">
                                            </div>
                                        </div>
                                        <div>
                                            <label for="atl_rg"
                                            ...
                                            <input type="text" name="atl_rg" id="atl_rg"
                                                class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                                value="{{ old('atl_rg', $atleta->atl_rg_formatted) }}" maxlength="12">
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="email" name="atl_email" id="atl_email"
                                            class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                            value="{{ old('atl_email', $atleta->atl_email) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                <div>
                                    ...
                                    <input type="text" name="atl_celular" id="atl_celular"
                                        class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                        value="{{ old('atl_celular', $atleta->atl_celular_formatted) }}" maxlength="15">
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="atl_telefone" id="atl_telefone"
                                        class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                        value="{{ old('atl_telefone', $atleta->atl_telefone_formatted) }}"
                                        maxlength="14">
                                </div>
                                <div>
                                    <label for="atl_sexo"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <input type="date" name="atl_dt_nasc" id="atl_dt_nasc"
                                        class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                        value="{{ old('atl_dt_nasc', $atleta->atl_dt_nasc) }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="atl_cep" id="atl_cep"
                                    class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                    value="{{ old('atl_cep', $atleta->atl_cep) }}" maxlength="9">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                                <div class="md:col-span-3">
                                    ...
                                    <input type="text" name="atl_endereco" id="atl_endereco"
                                        class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                        value="{{ old('atl_endereco', $atleta->atl_endereco) }}">
                                </div>
                                <div class="md:col-span-1">
                                    ...
                                    <input type="text" name="atl_numero" id="atl_numero"
                                        class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                        value="{{ old('atl_numero', $atleta->atl_numero) }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="atl_bairro" id="atl_bairro"
                                    class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                    value="{{ old('atl_bairro', $atleta->atl_bairro) }}">
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                                <div class="md:col-span-3">
                                    ...
                                    <input type="text" name="atl_cidade" id="atl_cidade"
                                        class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                        value="{{ old('atl_cidade', $atleta->atl_cidade) }}">
                                </div>
                                <div class="md:col-span-1">
                                    ...
                                    <input type="text" name="atl_estado" id="atl_estado"
                                        class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                        value="{{ old('atl_estado', $atleta->atl_estado) }}" maxlength="2">
                                </div>
                            </div>
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <div class="flex items-center h-10 mt-6">
                                        <input id="cartao_impresso_ano_atual" name="cartao_impresso_ano_atual"
                                            ...
                                            {{ $cartaoImpresso ? 'checked' : '' }} {{ !auth()->user()->hasRole('Administrador') ? 'disabled' : '' }}>
                                    ...
                                    @if($atleta->cartoes->count() > 0)
                                        <div class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                                            Histórico:
                                            @foreach($atleta->cartoes->where('atc_impresso', true)->sortByDesc('atc_ano') as $cartao)
                                                <span
                                                    class="bg-gray-200 dark:bg-gray-700 px-1 rounded mr-1">{{ $cartao->atc_ano }}</span>
                                            @endforeach
                                        </div>
                                    @endif
                                </div>
                            ...
                            <div class="flex justify-start mt-6 space-x-4">
                                <button type="submit"
                                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Salvar
                                    Alterações</button>
