        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('times.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">
                        @hasrole('ResponsavelTime') Meu Time @else Times @endhasrole
                    </span>
                </a>
            </li>
            @endif
            ...
            <li>
                ...
                <ul id="dropdown-funcoes" class="hidden py-2 space-y-2">
                    ...
                    <li>
                        <a href="{{ route('equipes.index') }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Equipes</a>
                    </li>
                     <li>
            ...
            <li>
                ...
                <ul id="dropdown-configuracoes" class="hidden py-2 space-y-2">
                    ...
                    <li>
                        <a href="{{ route('categorias.index') }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Categorias</a>
                    </li>
                    <li>
                        <a href="{{ route('ginasios.index') }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Ginásios</a>
                    </li>
                </ul>
            </li>
            @endhasrole         
