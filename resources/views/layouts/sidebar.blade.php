...
<aside id="sidebar-multi-level-sidebar"
    class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 sm:top-20"
    aria-label="Sidebar">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('eventos.index') }}"
                    ...
                    <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        ...
                        <path
                            d="M19 4h-2V3a1 1 0 0 0-2 0v1H7V3a1 1 0 0 0-2 0v1H3a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2Zm-1 9H2v-2h16v2Zm0-4H2V6h16v3Z" />
                    </svg>
            ...
            <li>
                <a href="{{ route('jogos.index') }}"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg class="w-6 h-6 shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
            ...
            <li>
                <button type="button"
                    ...
                    aria-controls="dropdown-funcoes" data-collapse-toggle="dropdown-funcoes">
                ...
                <ul id="dropdown-funcoes" class="hidden py-2 space-y-2">
                    ...
                    <li>
                        <a href="{{ route('atletas.index') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Atletas</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('agendamentos.comissao.index') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Agendamentos Pendentes</a>
                    </li>
            ...
            <li>
                <button type="button"
                    class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                    aria-controls="dropdown-relatorios" data-collapse-toggle="dropdown-relatorios">

                    <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd" d="M9 7V2.221a2 2 0 0 0-.5.365L4.586 6.5a2 2 0 0 0-.365.5H9Zm2 0V2h7a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V9h5a2 2 0 0 0 2-2Zm2-2a1 1 0 1 0 0 2h3a1 1 0 1 0 0-2h-3Zm0 3a1 1 0 1 0 0 2h3a1 1 0 1 0 0-2h-3Zm-4 4a1 1 0 0 1 1-1h6a1 1 0 1 1 0 2H10a1 1 0 0 1-1-1Zm0 4a1 1 0 0 1 1-1h6a1 1 0 1 1 0 2H10a1 1 0 0 1-1-1Z" clip-rule="evenodd"/>
                    </svg>
            ...
            <li>
                <button type="button"
                    class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                    aria-controls="dropdown-configuracoes" data-collapse-toggle="dropdown-configuracoes">
                ...
                <ul id="dropdown-configuracoes" class="hidden py-2 space-y-2">
                    ...
                    <li>
                        <a href="{{ route('profiles.index') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Perfil</a>
                    </li>
                    <li>
                        <a href="{{ route('role-permission.index') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Permissões</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('torneio-inicio.index') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Torneio Início</a>
                    </li>
                    <li>
                        <a href="{{ route('ginasios.index') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Ginásios</a>
                    </li>
                    <li>
                        <a href="{{ route('documentos.index') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Gerenciar Documentos</a>
                    </li>
                </ul>
            </li>
            @endhasrole
            ...
            <li>
                <a href="{{ route('arbitros.index') }}"
                    ...
                    <span class="ms-3 whitespace-nowrap">Árbitros/Apontador</span>
                </a>
            </li>
            @endhasrole
            ...
            <li>
                <a href="{{ route('documentos.index') }}"
                    ...
                    <span class="ms-3 whitespace-nowrap">Documentos</span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('ginasios.index') }}"
                    ...
                    <span class="ms-3 whitespace-nowrap">Ginásios</span>
                </a>
            </li>
