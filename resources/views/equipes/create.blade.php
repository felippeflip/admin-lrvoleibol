                    ...
                    <div class="container mx-auto p-4">
                        ...
                        <form action="{{ route('equipes.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="eqp_nome_detalhado" id="eqp_nome_detalhado" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500" value="{{ old('eqp_nome_detalhado') }}" required>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="eqp_nome_treinador" id="eqp_nome_treinador" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500" value="{{ old('eqp_nome_treinador') }}">
