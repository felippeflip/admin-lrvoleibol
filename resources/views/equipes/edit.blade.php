                    ...
                    <div class="container mx-auto p-4">
                        ...
                        <form action="{{ route('equipes.update', $equipe->eqp_id) }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="eqp_nome_treinador" id="eqp_nome_treinador" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500">
