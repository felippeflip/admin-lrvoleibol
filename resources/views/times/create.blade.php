                        ...
                        <form action="{{ route('times.store') }}" method="POST" enctype="multipart/form-data" id="timeForm">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                                ...
                                <div class="md:col-span-1 flex flex-col items-center justify-center">
                                    ...
                                    <div class="w-48 h-36 border border-gray-300 dark:border-gray-600 rounded-lg overflow-hidden flex items-center justify-center mb-2">
                                        {{-- Pré-visualização da Logo --}}
                                        <img id="logoPreview" src="{{ Vite::asset('resources/images/placeholder-time-logo.png') }}" alt="Pré-visualização da Logo" class="w-full h-full object-contain">
                                    </div>
                                    <input name="tim_logo" id="tim_logo" type="file" accept="image/jpeg, image/png, image/jpg" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="logo_help">
                                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-300" id="logo_help">Tamanho ideal: retangular (e.g., 4:3 ou 16:9)</p>
                                </div>
                                ...
                                <div class="md:col-span-3">
                                   <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="tim_nome_abre" id="tim_nome_abre" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500" value="{{ old('tim_nome_abre') }}">
                                    </div>
                                    <div class="mb-4">
                                        <label for="tim_email" class="block text-gray-700 dark:text-gray-300 mb-2">E-mail:</label>
                                        <input type="email" name="tim_email" id="tim_email" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500" value="{{ old('tim_email') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <input type="text" name="tim_celular" id="tim_celular" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500" value="{{ old('tim_celular') }}" maxlength="15">
                                </div>
                                <div>
                                    <label for="tim_telefone" class="block text-gray-700 dark:text-gray-300 mb-2">Telefone:</label>
                                    <input type="text" name="tim_telefone" id="tim_telefone" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500" value="{{ old('tim_telefone') }}" maxlength="14">
                                </div>
                            </div>

                            <div class="mb-4">
                                <label for="tim_cnpj" class="block text-gray-700 dark:text-gray-300 mb-2">CNPJ:</label>
                                <input type="text" name="tim_cnpj" id="tim_cnpj" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500" value="{{ old('tim_cnpj') }}" maxlength="18">
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                                <div class="md:col-span-3">
                                    ...
                                    <input type="text" name="tim_endereco" id="tim_endereco" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500" value="{{ old('tim_endereco') }}">
                                </div>
                                <div class="md:col-span-1">
                                    <label for="tim_numero" class="block text-gray-700 dark:text-gray-300 mb-2">Número:</label>
                                    <input type="text" name="tim_numero" id="tim_numero" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500" value="{{ old('tim_numero') }}">
                                </div>
                            </div>

                            <div class="mb-4">
                                <label for="tim_bairro" class="block text-gray-700 dark:text-gray-300 mb-2">Bairro:</label>
                                <input type="text" name="tim_bairro" id="tim_bairro" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500" value="{{ old('tim_bairro') }}">
                            </div>

                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                                <div class="md:col-span-3">
                                    <label for="tim_cidade" class="block text-gray-700 dark:text-gray-300 mb-2">Cidade:</label>
                                    <input type="text" name="tim_cidade" id="tim_cidade" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500" value="{{ old('tim_cidade') }}">
                                </div>
                                <div class="md:col-span-1">
                                    <label for="tim_uf" class="block text-gray-700 dark:text-gray-300 mb-2">UF:</label>
                                    <input type="text" name="tim_uf" id="tim_uf" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500" value="{{ old('tim_uf') }}" maxlength="2">
                                </div>
                            </div>
