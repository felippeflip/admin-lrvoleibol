                                ...
                                <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <select name="status" id="status"
                                            ...
                                            <option value="1" {{ request('status', '1') == '1' ? 'selected' : '' }}>Ativo
                                            </option>
                                ...
                                <tbody>
                                    @foreach ($times as $time)
                                        <tr
                                            ...
                                            <td class="px-6 py-4">
                                                <img src="{{ $time->tim_logo_url }}" alt="Logo {{ $time->tim_nome }}"
                                            ...
                                            <td class="px-6 py-4 flex flex-col space-y-2 justify-center items-center">
                                                ...
                                                <div class="flex space-x-2 w-full justify-center items-center">
                                                    ...
                                                    <form action="{{ route('times.inactivate', $time->tim_id) }}"
                                                        ...
                                                        onsubmit="return confirm('Tem certeza que deseja {{ $time->tim_status ? 'desativar' : 'ativar' }} este time?');">
                                                        @csrf
                                                        @method('PATCH')
                                                        <button type="submit" class="w-full h-full"
                                                            title="{{ $time->tim_status ? 'Desativar' : 'Ativar' }} Time">
                                                            @if($time->tim_status)
