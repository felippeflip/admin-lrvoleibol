            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="container mx-auto p-4">
                        ...
                        @endif
                        <form action="{{ route('times.update', $time->tim_id) }}" method="POST"
                            enctype="multipart/form-data" id="timeEditForm">
                            @csrf
                            ...
                            <div class="mb-6"> {{-- Aumentando a margem para o bloco do logo --}}
                                ...
                                @if ($time->tim_logo_url)
                                    <div class="mb-4">
                                        ...
                                        <img id="current-logo-preview" src="{{ $time->tim_logo_url }}" alt="Logo Atual"
                                            class="max-w-xs h-auto object-contain border border-gray-300 dark:border-gray-600 p-2 rounded-lg">
                                    </div>
                                @endif
                                <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">Selecione um novo logo (ou
                                    visualize abaixo):</p>
                                <input name="tim_logo" id="tim_logo" type="file" accept="image/jpeg, image/png"
                                    class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                    aria-describedby="user_avatar_help">
                                <div
                                    class="mt-4 border border-dashed border-gray-400 dark:border-gray-600 p-4 flex justify-center items-center min-h-[100px] rounded-lg">
                                    {{-- Área para pré-visualização --}}
                                    <img id="new-logo-preview" src="#" alt="Pré-visualização do Novo Logo"
                                        class="hidden max-w-full h-auto object-contain" style="max-height: 200px;"> {{--
                                    max-h para limitar altura --}}
                                    <span id="no-new-logo-text" class="text-gray-500 dark:text-gray-400">Nenhum logo
                                        selecionado para pré-visualização.</span>
                                </div>
                            </div>

                            @hasrole('Administrador')
                            <div class="mb-4">
                                <label for="tim_user_id" class="block text-gray-700 dark:text-gray-300 mb-2">Usuário
                                    Responsável do Time:</label>
                            ...
                            <div class="mb-4">
                                <label for="tim_nome" class="block text-gray-700 dark:text-gray-300 mb-2">Nome do Time
                                    *:</label>
                                <input type="text" name="tim_nome" id="tim_nome"
                                    class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                    value="{{ old('tim_nome', $time->tim_nome) }}" required>
                            </div>

                            <div class="mb-4">
                                <label for="tim_nome_abre" class="block text-gray-700 dark:text-gray-300 mb-2">Nome do
                                    Time Abreviado:</label>
                                <input type="text" name="tim_nome_abre" id="tim_nome_abre"
                                    class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                    value="{{ old('tim_nome_abre', $time->tim_nome_abre) }}">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="email" name="tim_email" id="tim_email"
                                    class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                    value="{{ old('tim_email', $time->tim_email) }}">
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <input type="text" name="tim_celular" id="tim_celular"
                                        class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                        value="{{ old('tim_celular', $time->tim_celular) }}">
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="tim_telefone" id="tim_telefone"
                                        class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                        value="{{ old('tim_telefone', $time->tim_telefone) }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="tim_cnpj" id="tim_cnpj"
                                    class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                    value="{{ old('tim_cnpj', $time->tim_cnpj) }}">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="tim_cep" id="tim_cep"
                                    class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                    value="{{ old('tim_cep', $time->tim_cep) }}">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                                <div class="md:col-span-3">
                                    ...
                                    <input type="text" name="tim_endereco" id="tim_endereco"
                                        class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                        value="{{ old('tim_endereco', $time->tim_endereco) }}">
                                </div>
                                <div class="md:col-span-1">
                                    ...
                                    <input type="text" name="tim_numero" id="tim_numero"
                                        class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                        value="{{ old('tim_numero', $time->tim_numero) }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="tim_bairro" id="tim_bairro"
                                    class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 p-2 rounded focus:ring-blue-500 focus:border-blue-500"
                                    value="{{ old('tim_bairro', $time->tim_bairro) }}">
                            </div>
