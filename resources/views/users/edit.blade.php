                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('users.update', $user->id) }}" method="POST">
                        ...
                        <div class="flex items-center mb-4">
                            ...
                            <input id="is_arbitro" name="is_arbitro" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded mr-4 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" value="1" {{ $user->is_arbitro ? 'checked' : '' }}>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="apelido" id="apelido" class="w-full border border-gray-300 p-2 rounded" value="{{ $user->apelido }}">
                        </div>
                        <div class="mb-4">
                            <label for="name" class="block text-gray-700">NOME COMPLETO:</label>
                            <input type="text" name="name" id="name" class="w-full border border-gray-300 p-2 rounded" value="{{ $user->name }}">
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="telefone" id="telefone" class="w-full border border-gray-300 p-2 rounded" value="{{ $user->telefone }}">
                        </div>

                        <div class="mb-4">
                            <label for="cpf" class="block text-gray-700">CPF:</label>
                            <input type="text" name="cpf" id="cpf" class="w-full border border-gray-300 p-2 rounded" value="{{ $user->cpf }}">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="tipo_arbitro" id="tipo_arbitro" class="w-full border border-gray-300 p-2 rounded" value="{{ $user->tipo_arbitro }}">
                        </div>

                        <div class="mb-4">
                            <label for="cep" class="block text-gray-700">CEP:</label>
                            <input type="text" name="cep" id="cep" class="w-full border border-gray-300 p-2 rounded" value="{{ $user->cep }}">
                        </div>

                        <div class="mb-4">
                            <label for="endereco" class="block text-gray-700">ENDEREÇO:</label>
                            <input type="text" name="endereco" id="endereco" class="w-full border border-gray-300 p-2 rounded" value="{{ $user->endereco }}">
                        </div>

                        <div class="mb-4">
                            <label for="bairro" class="block text-gray-700">BAIRRO:</label>
                            <input type="text" name="bairro" id="bairro" class="w-full border border-gray-300 p-2 rounded" value="{{ $user->bairro }}">
                        </div>   
                            <div class="mb-4 group">
                                <label for="cidade" class="block text-gray-700">CIDADE:</label>
                                <input type="text" name="cidade" id="cidade" class="w-full border border-gray-300 p-2 rounded" value="{{ $user->cidade }}">
                            </div>

                            <div class="mb-4">
                                <label for="estado" class="block text-gray-700">ESTADO:</label>
                                <input type="text" name="estado" id="estado" class="w-full border border-gray-300 p-2 rounded" value="{{ $user->estado }}">
                            </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('resetPasswordUser', $user->id) }}" method="POST">
                        ...
                        <div class="flex justify-between">
                            <button type="submit" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Redefinir Senha</button>
                        </div>
                    </form>
                </div>
            </div>
