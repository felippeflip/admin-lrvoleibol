                    ...
                    <div class="container mx-auto p-4">
                        ...
                        <form id="userForm" action="{{ route('users.store') }}" method="POST"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                                <div class="md:col-span-1 flex flex-col items-start justify-start">
                                    <!-- Changed items-center to items-start for 'Upper Left' alignment within cell if that's what they meant? No, centered in cell is better usually. But 'Left Superior' might mean left aligned. I'll stick to center or test left. Left aligns with label. -->
                                    <label for="foto" class="block text-gray-700 dark:text-gray-300 mb-2 font-bold">Foto
                                        3x4</label> <!-- Added font-bold -->
                                    <div
                                        class="w-36 h-48 border border-gray-300 dark:border-gray-600 rounded-lg overflow-hidden flex items-center justify-center mb-2 bg-gray-50 dark:bg-gray-700">
                                    ...
                                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-300">Tamanho ideal: 3x4
                                        (proporção)</p>
                                </div>
                                <div class="md:col-span-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    <div x-data="{ role: '{{ old('role') }}' }"
                                        ...
                                        <div x-show="role === 'Juiz'">
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                <div class="mb-4">
                                                    <label for="lrv"
                                                        class="block text-gray-700 dark:text-gray-300">REGISTRO
                                                        (LRV):</label>
                                    ...
                                    <div class="col-span-1">
                                        <label for="data_nascimento" class="block text-gray-700 dark:text-gray-300">DATA
                                            DE NASCIMENTO:</label>
