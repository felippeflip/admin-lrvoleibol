                        ...
                        <form action="{{ route('users.store') }}" method="POST">
                            ...
                            <div class="flex items-center mb-4">
                                ...
                                <input id="is_arbitro" name="is_arbitro" type="checkbox"
                                    ...
                                    value="1" {{ old('is_arbitro') ? 'checked' : '' }}>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="telefone" id="telefone"
                                    class="w-full border border-gray-300 p-2 rounded" value="{{ old('telefone') }}">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="cref" id="cref"
                                    class="w-full border border-gray-300 p-2 rounded" value="{{ old('cref') }}">
                            </div>

                            <div class="mb-4">
                                <label for="tipo_arbitro" class="block text-gray-700">CATEGORIA:</label>
                                <input type="text" name="tipo_arbitro" id="tipo_arbitro"
                                    class="w-full border border-gray-300 p-2 rounded" value="{{ old('tipo_arbitro') }}">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="endereco" id="endereco"
                                    class="w-full border border-gray-300 p-2 rounded" value="{{ old('endereco') }}">
                            </div>

                            <div class="mb-4">
                                <label for="bairro" class="block text-gray-700">BAIRRO:</label>
                                <input type="text" name="bairro" id="bairro"
                                    class="w-full border border-gray-300 p-2 rounded" value="{{ old('bairro') }}">
                            </div>
                            <div class="mb-4 group">
                                <label for="cidade" class="block text-gray-700">CIDADE:</label>
                                <input type="text" name="cidade" id="cidade"
                                    class="w-full border border-gray-300 p-2 rounded" value="{{ old('cidade') }}">
                            </div>
