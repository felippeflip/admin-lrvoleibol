                                    ...
                                    @foreach ($users as $user)
                                        <tr
                                            ...
                                            <td class="py-3 px-6 text-center">
                                                <span
                                                    class="{{ $user->active ? 'bg-green-200 text-green-600' : 'bg-red-200 text-red-600' }} py-1 px-3 rounded-full text-xs">
                                            ...
                                            <td class="py-3 px-6 text-center">
                                                <div class="flex item-center justify-center space-x-2">
                                                    ...
                                                    <form action="{{ route('users.toggleStatus', $user->id) }}"
                                                        ...
                                                        onsubmit="return confirm('Tem certeza que deseja {{ $user->active ? 'desativar' : 'ativar' }} este usuário?');">
                                                        @csrf
                                                        @method('PATCH')
                                                        <button type="submit"
                                                            class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110"
